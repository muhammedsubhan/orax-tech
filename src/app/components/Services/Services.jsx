            ...
            {services.map((item) => {
              return (
                <>
                  <div
                    key={item.id}
                    className="flex flex-col  border border-gray-300 gap-8  w-[165px] h-[210px] md:w-[140px] md:h-[180px] sm:w-[100px] sm:h-[110px] sm:p-3 md:gap-4 p-5 items-start rounded-3xl  hover:shadow-2xl transition duration-300"
                  >
                    <Image
                      src={`/${item.img}`}
                      height={80}
